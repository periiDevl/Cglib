...
"\n"
" int samples = 20;\n"
" float diskRadius = currentDepth / farPlane * 0.05;\n"
" float angle = rand(fragPos) * 6.2831853;\n"
" mat2 rot = mat2(cos(angle), -sin(angle), sin(angle), cos(angle));\n"
"\n"
" float shadow = 0.0;\n"
" for(int i = 0; i < samples; ++i){\n"
"  vec3 offset = sampleOffsetDirections[i];\n"
"  offset.xy = rot * offset.xy;\n"
"  float closestDepth = texture(shadowMap, normalize(fragToLight + offset * diskRadius)).r;\n"
