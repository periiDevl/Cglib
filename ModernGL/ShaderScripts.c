...
// ============ FORWARD RENDERING SHADERS (FIXED) ============
...
" // CRITICAL: Keep normals in WORLD SPACE for shadow calculations\n"
...
");\n"
"\n"
"float ShadowCalculation(vec3 fragPos, vec3 lightPos, vec3 normal, samplerCube shadowMap, float lightIntensity){\n"
" // Direction from fragment to light (for cubemap lookup)\n"
" vec3 fragToLight = fragPos - lightPos;\n"
" float currentDepth = length(fragToLight);\n"
"\n"
" // Direction from light to fragment (for angle calculations)\n"
" vec3 lightDir = normalize(lightPos - fragPos);\n"
" float cosTheta = dot(normal, lightDir);\n"
"\n"
" // Surfaces facing away from light are already dark, don't add shadow\n"
" if(cosTheta <= 0.0) return 0.0;\n"
"\n"
" // Angle-dependent bias to prevent shadow acne\n"
" float bias = max(0.05 * (1.0 - cosTheta), 0.005);\n"
"\n"
" // Distance-based blur: shadows get MUCH softer as distance increases\n"
" float distanceRatio = currentDepth / farPlane;\n"
" float minRadius = 0.001;  // Very sharp close up\n"
" float maxRadius = 0.15;   // Very blurry far away\n"
" // Use cubic curve for even more aggressive blur at distance\n"
" float blurFactor = distanceRatio * distanceRatio * distanceRatio;\n"
" float diskRadius = mix(minRadius, maxRadius, blurFactor);\n"
"\n"
" int samples = 20;\n"
" float shadow = 0.0;\n"
"\n"
...
"  \n"
"  // Sample cubemap depth at offset position\n"
"  float closestDepth = texture(shadowMap, fragToLight + offset).r;\n"
"  closestDepth *= farPlane;\n"
"  \n"
"  // If current fragment is further from light, it's in shadow\n"
...
"  vec3 diffuse = material.diffuse * diff * lights[i].diffuse * lights[i].color;\n"
"  \n"
"  // Specular (Blinn-Phong)\n"
"  vec3 halfwayDir = normalize(lightDir + viewDir);\n"
"  float spec = pow(max(dot(norm, halfwayDir), 0.0), material.shininess);\n"
"  vec3 specular = material.specular * spec * lights[i].specular * lights[i].color;\n"
"\n"
"  // Calculate shadows\n"
"  float shadow = 0.0;\n"
"  if(i < shadowMapCount){\n"
"   float lightIntensity = (lights[i].diffuse + lights[i].specular) * 0.5;\n"
"   if(i == 0) shadow = ShadowCalculation(FragPos, lights[0].position, norm, shadowMaps[0], lightIntensity);\n"
"   else if(i == 1) shadow = ShadowCalculation(FragPos, lights[1].position, norm, shadowMaps[1], lightIntensity);\n"
"   else if(i == 2) shadow = ShadowCalculation(FragPos, lights[2].position, norm, shadowMaps[2], lightIntensity);\n"
"   else if(i == 3) shadow = ShadowCalculation(FragPos, lights[3].position, norm, shadowMaps[3], lightIntensity);\n"
"  }\n"
"\n"
"  // Combine: ambient always visible, diffuse+specular affected by shadows\n"
...
const char *unlitVertexShaderSource = "#version 330 core\n"
"layout(location=0) in vec3 aPos;\n"
"uniform mat4 model;\n"
"uniform mat4 view;\n"
"uniform mat4 projection;\n"
...
const char *unlitFragmentShaderSource = "#version 330 core\n"
"out vec4 FragColor;\n"
"in vec3 FragPos;\n"
"in vec3 Normal;\n"
"in vec3 ViewPos;\n"
