...
// ============ FORWARD RENDERING SHADERS (WITH PROPER POINT LIGHT ATTENUATION) ============
...
" float diffuse;\n"
" float specular;\n"
" float constant;\n"    // NEW: Attenuation constant term
" float linear;\n"       // NEW: Attenuation linear term
" float quadratic;\n"    // NEW: Attenuation quadratic term
"};\n"
...
"  \n"
"  // Calculate attenuation using inverse square law with adjustable parameters\n"
"  float attenuation = 1.0 / (lights[i].constant + lights[i].linear * distance + \n"
"                             lights[i].quadratic * (distance * distance));\n"
"  \n"
"  // Ambient is minimally affected by attenuation (optional: remove attenuation from ambient)\n"
"  vec3 ambient = material.ambient * lights[i].ambient * lights[i].color;\n"
"  \n"
"  // Diffuse lighting with attenuation\n"
"  vec3 lightDir = normalize(lights[i].position - FragPos);\n"
"  float diff = max(dot(norm, lightDir), 0.0);\n"
"  vec3 diffuse = material.diffuse * lights[i].diffuse * diff * lights[i].color * attenuation;\n"
"  \n"
"  // Specular lighting with attenuation\n"
"  vec3 halfwayDir = normalize(lightDir + viewDir);\n"
"  float spec = pow(max(dot(norm, halfwayDir), 0.0), material.shininess);\n"
"  vec3 specular = material.specular * lights[i].specular * spec * lights[i].color * attenuation;\n"
"  \n"
"  // Shadow calculation\n"
"  float shadow = 0.0;\n"
"  if(i < shadowMapCount){\n"
